...
public class GameLogic {
    ...
    //1st element --> row, 2nd element --> col, 3rd element --> line type (hor, ver, diag)
    ...
    public boolean updateGameBoard(int row, int col){
        if(gameBoard[row-1][col-1] == 0){
            ...
            if(playerNames[player%2].equals("")){
                playerTurn.setText(("Player" + Integer.toString(player%2 + 1) + "'s Turn"));
            }else{
                playerTurn.setText((playerNames[player%2] + "'s Turn"));
            }
